...
> {
    ...
    this._allItems = [
      {
        ...
        more: (
          <div>
            <ActionButton
              title={"Share"}
              className={"hoverEffect shareButton"}
            ...
            >
              <FontIcon
                aria-label="share"
                className={[classNames.IconImg, classNames.share].join(" ")}
                iconName="Share"
              />
            </ActionButton>
            <IconButton
              iconProps={moreIcon}
              menuProps={this._menuItems(0)}
              title={"More"}
      ...
      {
        key: 1,
        name: "Power Bi business report FY21111",
        added: 1614277800000,
        owner: "Tim debor",
        type: "Link",
        link: "",
      ...
      {
        key: 2,
        name: "Power Bi business report FY212222",
        added: 1614277800000,
        owner: "Tim debor",
        type: "Link",
        link: "",
      ...
      {
        key: 3,
        name: "Power Bi business report FY25",
        added: 1614277800000,
        owner: "Tim debor",
        type: "Link",
        link: "",
    ...
    return (
      <div className={"resource-list-items"}>
        <div className={classNames.header}>
          <ActionButton
            className={classNames.fontSize}
            iconProps={addIcon}
            allowDisabledFocus
            componentRef={this.buttonRef}
            onClick={() => {
              this._openModal("A", "add");
            }}
          >
            New item
          </ActionButton>
  ...
  private _onFilter = (text: string | undefined): void => {
    this.setState({
      items: text
        ? this._filterPlainArray(this._allItems, {
            name: text,
          })
        : this._allItems,
    });
  ...
  private _findRecord = () => {
    if (this.state.modalAction === "A") {
      ...
      return (
        ...
        this.state.items.find((item) => item.key === this.state.actionKey)
      );
    }
  };
  private _dialog = () => {
    const dialogContentProps = {
      ...
      title:
        this.state.modalAction === "A"
          ? "Add a resource"
          : this.state.modalAction === "D"
      ...
      >
        {this.state.modalAction === "A" || this.state.modalAction === "E" ? (
          <>
            ...
            <TextField
              label="Link"
              defaultValue={recordData && recordData.link}
              componentRef={this.inputLink}
              styles={this._getStyles}
              placeholder="Add URL"
              errorMessage={this.state.error.link}
            />
            <DialogFooter>
        ...
        more: (
          <div>
            ...
            <IconButton
              aria-label="More"
              iconProps={moreIcon}
              menuProps={this._menuItems(keyItem)}
              title={"More"}
              className={"hoverEffect"}
            />
          </div>
